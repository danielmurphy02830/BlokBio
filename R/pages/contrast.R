#' Contrast Module UI
contrastUI <- function(id, template_file) {
  ns <- NS(id)
  
  # Similar approach to workspaces: Render the whole template via UI output 
  # to inject the table.
  tagList(
...
#' Contrast Module Server
contrastServer <- function(id, template_file) {
